...
<?php } ?>
<?php if($page == 'deposit_cash' || $page == 'checkout' || $page == 'checkout_step2' || $page == 'buildcheckoutshop' || $page == 'buildshopcheckout2') { ?>
    ...
    $('#payment-form').bootstrapValidator({
        ...
        fields: {
			...
			checkout_method: {
				validators: {
					notEmpty: {
						message: 'Please select method for deposit funds'
					}
				}
			},
			cardnumber: {
		selector: '#cardnumber',
                validators: {
                    notEmpty: {
                        message: 'The credit card number is required & can\'t be empty'
                    },
					creditCard: {
...
<?php } else if($page == 'checkout' || $page == 'buildcheckoutshop' || $page == 'buildshopcheckout2') { ?>
<script type="text/javascript">
$(document).ready(function() {
    $('#payment-form').bootstrapValidator({
        message: 'This value is not valid',
