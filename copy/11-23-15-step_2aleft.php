		...
		<div class="sugget_left">
			...
			<?php /*?><div class="terms">
				<div class="squaredFour left">
					<input type="radio" value="sjester" id="eleven" name="radiog_lite" <?php if($page == 'only' || $page == 'iftClique' || $page == 'similar_persons') { ?> checked="checked"<?php } else { }?> />
					<label for="eleven"></label>
				</div>
				<label class="title">s&rsquo;Jester</label>
			</div><?php */?>
			<div class="image">
				...
				<img src="<?php echo ru_resource; ?>images/you_img.jpg" id="user_img" <?php if($page == 'only' || $page == 'iftClique' || $page == 'similar_persons') { ?>style="display:none" <?php } else { }?> alt="Jester Image" />
			</div>
			<div class="terms">
				<div class="squaredFour left">
					...
					<div id="contentWrap2" <?php if($_SESSION['from_price']['optional1'] !='') {?> style="display:block"<?php } else { ?>style="display:none" <?php } ?> >		
						<div class="flied">
							...
							<input type="hidden" name="price_search" id="price_search" value="1" >
								<input type="text" name="from_price" id="from_price" placeholder="$50"  value="<?php echo $s; ?>" /> 
								<span>to</span>
								<input type="text" name="to_price" id="to_price" placeholder="$2,500"  value="<?php echo $o; ?>" /> 
